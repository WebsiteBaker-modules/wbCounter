...
$table_day   = TABLE_PREFIX .'mod_counter_day';
$table_ips   = TABLE_PREFIX .'mod_counter_ips';
$table_pages = TABLE_PREFIX .'mod_counter_pages';
$table_ref   = TABLE_PREFIX .'mod_counter_ref';
$table_key   = TABLE_PREFIX .'mod_counter_keywords';
$table_lang  = TABLE_PREFIX .'mod_counter_lang';
...
class wbstats {
    ...
    function getStats() {
        ...
        $res = $query->fetchRow(MYSQLI_ASSOC);
        ...
        if($query) {
            ...
            if($result['online']) {
                $result['online_title'] = '<table class=\'popup\' ><tr><th colspan=\'4\'>'.$WS['CURRENTONLINE'].'</th></tr>';
